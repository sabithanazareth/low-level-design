...
class RentalSystem:
  ...
  def process_payment(self, reservation):
      return self.payment_processor.process_payment(reservation.calculate_total_price())
...
class CarRentalSystem:
  ...
  def run():
    ...
    start_date = date.fromisoformat('2025-06-16')
    ...
    if available_cars:
      ...
      if reservation is not None:
          ...
          if payment_success:
              print(f"Reservation successful. Reservation ID: {reservation.reservation_id}")
          else:
